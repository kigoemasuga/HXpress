...
import com.example.android.hxpress.aciticties.WritingThingWanted;
...
public class MoreInfoFragment extends BaseMainFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_edit_thingwanted, container, false);
        ButterKnife.bind((Activity) view.getContext());
        //初始化Bmob
        Bmob.initialize(view.getContext(), AppManager.appID);
   ...
   /* private void initView(View view) {
    ...
    private void initMRichEditor() {
        editor = (MRichEditor) view.findViewById(R.id.mre_editor);
    ...
    private void preview() {
        ...
        View DialogView = View.inflate(view.getContext(), R.layout.dialog_preiview_html, null);
        wvPreiview = (WebView) DialogView.findViewById(R.id.wv_dialog_preiview_html);
        ImageView ivClose = (ImageView) DialogView.findViewById(R.id.iv_dialog_close);
        ImageView ivRefresh = (ImageView) DialogView.findViewById(R.id.iv_dialog_refresh);
...
//        editor.setHtmlTitle(titleTextview.getText().toString().trim());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_CANCELED) {
            Toast.makeText(view.getContext(), "取消操作", Toast.LENGTH_LONG).show();
            return;
        }
